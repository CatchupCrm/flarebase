...
class KbServiceProvider extends ServiceProvider
{
    ...
    {
        $viewPath = base_path('resources/views/modules/kb');
        ...
        }, \Config::get('view.paths')), [$sourcePath]), 'kb');
    }
    ...
    {
        $langPath = base_path('resources/lang/modules/kb');
